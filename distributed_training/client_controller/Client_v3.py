...
class Client_v3:
    ...
    def start(self):
        ...
        # Topics
        self.t_cmd = self.dp.create_topic("train/train_cmd", "TrainCmd", dds.TOPIC_QOS_DEFAULT, None, 0)
        self.t_upd = self.dp.create_topic("train/client_update", "ClientUpdate", dds.TOPIC_QOS_DEFAULT, None, 0)
        self.t_model = self.dp.create_topic("train/model_blob", "ModelBlob", dds.TOPIC_QOS_DEFAULT, None, 0)
        ...
        class TrainCmdListener(dds.DataReaderListener):
            ...
            def process(self, reader, cmd, info):
                ...
                try:
                    ...
                    print(f"[Client_v3] local train+pack cost: {t1 - t0} ms")
